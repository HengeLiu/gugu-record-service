...
@Biz
@Slf4j
public class UserIngredientModelBiz {
    ...
    public ModelIngredientCategoryModelVo calculateIntakesModelByUserInfo(UserInfoVo userInfoVo) {
    ...
    public ModelIngredientCategoryModelVo queryMostNeededModel() {
        ...
        ModelIngredientCategoryModelVo defaultUserModel = calculateIntakesModelByUserInfo(configPropertiesService.getDefaultUserInfo());
