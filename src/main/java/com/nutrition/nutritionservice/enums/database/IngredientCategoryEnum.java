...
public enum IngredientCategoryEnum implements CodeEnum<Integer> {
    ...
    UNKNOWN(0, "unknown", "未知", IngredientSuperCategoryEnum.UNKNOWN, ""),
    ...
    private final String commonIngredientNameArrayStr;

    IngredientCategoryEnum(int code, String nameEn, String nameZh, IngredientSuperCategoryEnum parentCategory,
            String commonIngredientNameArrayStr) {
        this.code = code;
        this.nameEn = nameEn;
        this.nameZh = nameZh;
        this.parentCategory = parentCategory;
        this.commonIngredientNameArrayStr = commonIngredientNameArrayStr;
    }
    ...
    public String getCommonIngredientNameArrayStr() {
        return commonIngredientNameArrayStr;
    }
}
